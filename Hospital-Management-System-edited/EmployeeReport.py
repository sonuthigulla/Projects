...
patient_info_frame.grid(row=0, column=0, sticky="news", padx=20, pady=30)

report_label = tk.Label(patient_info_frame, text="Report on the Employees in the System", font='Calibri, 15', anchor="c")
...
tree = ttk.Treeview(report_frame,column=("1", "2", "3", "4", "5", "6", "7", "8", "9"), show='headings')
...
def disable_button():
    btnDisplay.config(state=tk.DISABLED)
btnDisplay.config(command=lambda: [View(), disable_button()])
