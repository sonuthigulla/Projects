...
class Employee:
    def __init__(self,master):
        ...
        self.emp_salary=tkinter.IntVar()
        ...
        designations = ['Doctor', 'Nurse', 'Administrator', 'Technician', 'Support Staff', 'Therapist']
        self.etype1_combobox = ttk.Combobox(self.LoginFrame, font="Helvetica 14 bold", textvariable=self.emp_type_var,
                                            values=designations, state="readonly")
        self.etype1_combobox.grid(row=4, column=1)
        ...
        self.lblAlt = Label(self.LoginFrame,text="EXPERIENCE(YEARS)",font="Helvetica 14 bold",bg="cadet blue",bd=22)
   ...
   #FUNCTION TO EXIT PATIENT FORM
    ...
    def INSERT_EMP(self):
        ...
        selected_designation = self.emp_type_var.get()
        conn = sqlite3.connect("HospitalDB.db")     
        ...
        if x!=0:
            ...
            conn.execute("INSERT INTO employee VALUES(?,?,?,?,?,?,?,?,?)",(e1,e2, selected_gender,e4,selected_designation,e6,e7,e8,e9,))
